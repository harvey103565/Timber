 ...
 * Changes:
 * - from "evaluator.isMemberInClass(method, "timber.log.Timber")" to "evaluator.isMemberInClass(method, "woods.log.timber.Timber")"
 */
...
public final class WrongTimberUsageDetector extends Detector implements Detector.JavaPsiScanner {
    ...
    public void visitMethod(JavaContext context, JavaElementVisitor visitor,
        ...
        if ("tag".equals(methodName) && evaluator.isMemberInClass(method, "woods.log.timber.Timber")) {
        ...
        if (evaluator.isMemberInClass(method, "woods.log.timber.Timber") //
                || evaluator.isMemberInClass(method, "woods.log.timber.Timber.Tree")) {
    ...
    private static boolean checkConditionalUsage(JavaContext context, PsiMethodCallExpression call,
        ...
        return !checkElement(context, call, thenElement) && checkElement(context, call, elseElement);
    }
